...
export const SinglePlanet = (props) => {
  ...
  const planet = {
    ...store.planets[Number(params.uid) - 1],
    description: "Una descripción ficticia del planeta. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vel massa nec justo gravida vehicula. Integer feugiat elit a nisi auctor, a tincidunt arcu pellentesque. Quisque at tristique odio. Nunc id aliquet dolor."
  };
